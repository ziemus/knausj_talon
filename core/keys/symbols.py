...
symbols = [
    ...
    Symbol("\\", None, ["backslash", "box slash"]),
    ...
    Symbol("\u2018", None, ["left Brit quote", "blit quote"]),
    Symbol("\u2019", None, ["right Brit quote", "brit quote"]),
    # "guillemet" is not recognized
    Symbol("»", None, ["right geemay", "R geemay", "raquo"]),
    Symbol("«", None, ["left geemay", "L geemay", "laquo"]),
    Symbol("„", None, ["low double quote", "low dub"]),
    Symbol("”", None, ["high double quote", "hi dub"]),
    # non breaking space doesn't work with insert() so it cannot be added to punctuation_words
    Symbol("\u2011", None, ["no dash", "no break dash"]),
]
