...
class GameModeHelper:
    ...
    def add_active_game_icon():
        if GameModeHelper.is_current_game_active():
            icon = GameLibrary.get_current_game().get_icon_path()
    ...
    def is_current_game_active_and_game_mode():
        return GameModeHelper.is_game_active_and_game_mode(GameLibrary.get_current_game())
    ...
    def is_current_game_active():
        return GameModeHelper.is_game_active(GameLibrary.get_current_game())
    ...
    def get_current_game():
        return GameLibrary.get_current_game()
