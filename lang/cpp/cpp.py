# https://github.com/Nova38/thomas_talon/blob/main/lang/cplusplus/cplusplus.py
...
ctx.lists["user.cpp_standard_objects"] = {
    ...
    # <ios>
    "bool alpha": "boolalpha",
	"no bool alpha": "noboolalpha",

	"show base": "showbase",
	"no show base": "noshowbase",

	"show point": "showpoint",
	"no show point": "noshowpoint",

	"show pos": "showpos",
    "show positive": "showpos",
	"no show pos": "noshowpos",
    "no show positive": "noshowpos",

	"skip white": "skipws",
    "skip whitespace": "skipws",
	"no skip white": "noskipws",
    "no skip whitespace": "noskipws",

    "upper": "uppercase",
	"uppercase": "uppercase",
	"no upper": "nouppercase",
    "no uppercase": "nouppercase",

	"unit buff": "unitbuf",
	"no unit buff": "nounitbuf",
    ...
    "emit flush" : "emit_on_flush",
    "no emit flush": "noemit_on_flush",

    # <iomanip>
	"reset i o s flags": "resetiosflags",
	"set i o s flags": "setiosflags", #FIXME moved the ones that require arguments into standard functions
	"set base": "setbase",
	"set fill": "setfill",
